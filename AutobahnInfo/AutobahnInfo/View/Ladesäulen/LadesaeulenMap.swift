...
struct LadesaeulenMap: View {
    ...
    init(coordinate: CLLocationCoordinate2D, selectedCoordinate: Binding<CLLocationCoordinate2D?>) {
        self.coordinate = coordinate
        self._selectedCoordinate = selectedCoordinate // Initialize the binding
...
struct LadesaeulenMap_Previews: PreviewProvider {
    static var previews: some View {
        LadesaeulenMap(coordinate: CLLocationCoordinate2D(latitude: 54.362572, longitude: 10.979850), selectedCoordinate: .constant(nil))
    }
}
